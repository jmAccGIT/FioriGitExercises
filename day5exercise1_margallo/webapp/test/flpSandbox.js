		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#day5exercise1margallo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"day5exercise1margallo-display": {
								"semanticObject": "day5exercise1margallo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=day5exercise1margallo",
									"url": sap.ui.require.toUrl("day5exercise1margallo")
								}
							}
						}
					}
