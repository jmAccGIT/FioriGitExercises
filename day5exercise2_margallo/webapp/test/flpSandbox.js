		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#day5exercise2margallo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"day5exercise2margallo-display": {
								"semanticObject": "day5exercise2margallo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=day5exercise2margallo",
									"url": sap.ui.require.toUrl("day5exercise2margallo")
								}
							}
						}
					}
