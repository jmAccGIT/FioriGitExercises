		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Home Page",
									"targetURL": "#sapipstrainingemployeeapp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingemployeeapp2-display": {
								"semanticObject": "sapipstrainingemployeeapp2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.employeeapp2",
									"url": sap.ui.require.toUrl("sapips/training/employeeapp2")
								}
							}
						}
					}
