		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapipstrainingtestempapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapipstrainingtestempapp-display": {
								"semanticObject": "sapipstrainingtestempapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapips.training.testempapp",
									"url": sap.ui.require.toUrl("sapips/training/testempapp")
								}
							}
						}
					}
